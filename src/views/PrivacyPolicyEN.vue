<template>
	<Layout>
		<div class="col-span-12 text-center flex flex-col gap-2">
			<!-- static -->
			<p class="text-3xl font-semibold mb-10">Privacy Policy</p>

			<div class="bg-white shadow-md p-5 rounded-lg flex flex-col gap-6 text-justify">
				<!-- Main Content -->
